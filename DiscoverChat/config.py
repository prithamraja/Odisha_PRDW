...
from phase5d_retrieval_corpus import (            # noqa: E402
    ...
    # The WP-D10 storage format, from the module that decides it. The pin now
    # carries `storage_dtype`, so `pin_fingerprint()` differs between an fp32
    # corpus and an fp16 one and the checks below refuse the wrong one outright
...
DECOMPOSE_CORPUS_PATH = METAINSIGHTS / "decompose_corpus.json.gz"
DECOMPOSE_VECTORS_PATH = METAINSIGHTS / "decompose_corpus.npy"
DECOMPOSE_STAMP_PATH = METAINSIGHTS / "decompose_corpus_stamp.json"

# The sidecar is a large BUILD OUTPUT (36,218 records, ~81 MB with vectors),
